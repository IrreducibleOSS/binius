...
// };
// use binius_field::{
// 	as_packed_field::{PackScalar, PackedType}, linear_transformation::PackedTransformationFactory, packed::{RepackFromCanonical, TryRepackSliceInplace}, underlier::UnderlierType, BinaryField128b, BinaryField128bPolyval, PackedField, PackedFieldIndexable, TowerField
// };
...
// 	PackedType<U, BinaryField128bPolyval>: PackedTransformationFactory<PackedType<U, B128>>,
// 	PackedType<U, B128>:
// 		RepackFromCanonical<PackedType<U, B128>>
// 		+ TryRepackSliceInplace<PackedType<U, B128>>
// {
// 	let statement = Statement {
// 		boundaries,
// 		table_sizes: witness.table_sizes(),
// 	};
// 	let ccs = cs.compile::<CanonicalOptimalPackedTowerFamily>(&statement).unwrap();
