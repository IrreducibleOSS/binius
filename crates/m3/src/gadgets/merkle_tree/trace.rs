...
/// High-level model for binary Merkle trees using the Grøstl-256 output transformation as a
...
use crate::{builder::B8, emulate::Channel};
...
impl Default for MerkleTreeChannels {
	fn default() -> Self {
		Self::new()
	}
}
...
impl Default for MerkleBoundaries {
	fn default() -> Self {
		Self::new()
	}
}
