...
// 	fn populate<'a>(input: &[Self], underliers: impl Iterator<Item = &'a mut [U]>);
// }

// // TABLE BUILDER

// pub struct TableFiller<'a, Input: Filler> {
// 	input_count: usize,
// 	batch: Vec<Input>,
...
// impl<'a, Input: Filler> TableFiller<'a, Input> {
...
// impl<'a, Input: Filler> Drop for TableFiller<'a, Input> {
// 	fn drop(&mut self) {
