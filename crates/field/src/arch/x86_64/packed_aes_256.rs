...
cfg_if! {
	if #[cfg(target_feature = "gfni")] {
		...
		impl_transformation_with_strategy!(PackedAESBinaryField32x8b, crate::arch::GfniStrategy);
		...
		impl_transformation_with_strategy!(PackedAESBinaryField2x128b, crate::arch::GfniSpecializedStrategy256b);
	} else {
