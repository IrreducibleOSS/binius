...
impl_conversion!(U4, PackedBinaryField4x1b);
impl_conversion!(U4, PackedBinaryField2x2b);
impl_conversion!(U4, PackedBinaryField1x4b);

// Define tower
packed_binary_field_tower_impl!(
