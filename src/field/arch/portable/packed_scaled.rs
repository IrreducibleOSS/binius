...
macro_rules! packed_scaled_field {
	($name:ident = [$inner:ty;$size:literal]) => {
		pub type $name =
			$crate::field::arch::portable::packed_scaled::ScaledPackedField<$inner, $size>;

		impl std::ops::Add<<$inner as $crate::field::packed::PackedField>::Scalar> for $name {
			type Output = Self;

			fn add(self, rhs: <$inner as $crate::field::packed::PackedField>::Scalar) -> Self {
		...
		impl std::ops::AddAssign<<$inner as $crate::field::packed::PackedField>::Scalar> for $name {
			fn add_assign(&mut self, rhs: <$inner as $crate::field::packed::PackedField>::Scalar) {
				for i in 0..Self::WIDTH_IN_PT {
					self.0[i] += rhs;
				}
			}
		...
		impl std::ops::Sub<<$inner as $crate::field::packed::PackedField>::Scalar> for $name {
			type Output = Self;

			fn sub(self, rhs: <$inner as $crate::field::packed::PackedField>::Scalar) -> Self {
				let mut result = Self::default();
				for i in 0..Self::WIDTH_IN_PT {
					result.0[i] = self.0[i] - rhs;
				}
		...
		impl std::ops::SubAssign<<$inner as $crate::field::packed::PackedField>::Scalar> for $name {
			fn sub_assign(&mut self, rhs: <$inner as $crate::field::packed::PackedField>::Scalar) {
				for i in 0..Self::WIDTH_IN_PT {
					self.0[i] -= rhs;
				}
			}
		...
		impl std::ops::Mul<<$inner as $crate::field::packed::PackedField>::Scalar> for $name {
			type Output = Self;

			fn mul(self, rhs: <$inner as $crate::field::packed::PackedField>::Scalar) -> Self {
				let mut result = Self::default();
				for i in 0..Self::WIDTH_IN_PT {
					result.0[i] = self.0[i] * rhs;
				}
		...
		impl std::ops::MulAssign<<$inner as $crate::field::packed::PackedField>::Scalar> for $name {
			fn mul_assign(&mut self, rhs: <$inner as $crate::field::packed::PackedField>::Scalar) {
				for i in 0..Self::WIDTH_IN_PT {
					self.0[i] *= rhs;
				}
			}
		...
		unsafe impl<P> $crate::field::extension::PackedExtensionField<P> for $name
		where
			P: $crate::field::packed::PackedField,
			$inner: $crate::field::extension::PackedExtensionField<P>,
			<$inner as $crate::field::packed::PackedField>::Scalar:
				$crate::field::extension::ExtensionField<P::Scalar>,
		{
